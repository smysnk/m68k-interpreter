...
export const CPU_MODEL_REGISTRY: Readonly<Record<CpuModel, CpuModelDefinition>> = {
  ...
  m68010: {
    ...
    description: 'MC68000 with the supported MC68010 additions',
    capabilities: ['m68000-instructions', 'm68010-extensions', 'architectural-interrupts'],
  },
};

export const MACHINE_PROFILE_REGISTRY: Readonly<
  Record<MachineProfile, MachineProfileDefinition>
> = {
  bare: {
    id: 'bare',
    label: 'Bare',
...
export function normalizeEmulationConfig(
  ...
  const legacy = legacyProfile === null || legacyProfile === undefined
