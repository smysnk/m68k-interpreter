...
export const REGISTER_DESCRIPTORS: readonly RegisterDescriptor[] = [
  ...
  {
    key: 'isp', label: 'ISP', groupId: 'control', bitWidth: 32, decimalMode: 'unsigned',
    editable: true, minimumCpuModel: 'm68020',
    description: 'Interrupt supervisor stack pointer.',
  },
  {
    key: 'msp', label: 'MSP', groupId: 'control', bitWidth: 32, decimalMode: 'unsigned',
    editable: true, minimumCpuModel: 'm68020',
    description: 'Master supervisor stack pointer.',
  },
  {
    key: 'cacr', label: 'CACR', groupId: 'control', bitWidth: 32, decimalMode: 'unsigned',
    editable: true, minimumCpuModel: 'm68020',
    description: 'Instruction cache control register.',
  },
  {
    key: 'caar', label: 'CAAR', groupId: 'control', bitWidth: 32, decimalMode: 'unsigned',
    editable: true, minimumCpuModel: 'm68020',
